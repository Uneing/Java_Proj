...
public class MemberArrayListTest {
   ...
   public static void main(String[] args) {
      ...
      memberArrayList.addMember(memberLee);   //ArrayList에 객체를 각 방에 저장
      ...
      /*
       * ArrayList의 특징
         1.방번호 (index)가짐, 순차적으로 저장
         2.중복된 값을 저장 할 수 있다.
         3.방의 갯수가 무한정 늘어난다.(가변적)
         4.삭제할 경우 뒤의 방의 값이 자동으로 당겨온다.
         5.특정방에 값을 넣을때 자동으로 값이 뒤로 밀려들어간다.
       */
      memberArrayList.showAllMember();    //ArrayList 내의 모든 멤버를 출력
      memberArrayList.addMember2(3, memberPark2);
      memberArrayList.showAllMember();
      
      System.out.println("============멤버 비교============");
