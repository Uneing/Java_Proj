package ingeritance_07.lab11_instanceof;
...
public class InstanceOf02 {
	static void print(Animal a) {
		...
		if (a instanceof Egle) {
			System.out.println("Egle");
		}

		if (a instanceof HumanChild) {
			System.out.println("HumanChild");
		}

		if (a instanceof HumanChildson) {
	...
	public static void main(String[] args) {
		...
		print(new Lion());
		System.out.println("new Egle() -> \t");
		print(new Egle());
		System.out.println("new HumanChild() -> \t");
		print(new HumanChild());
		System.out.println("new HumanChildson() -> \t");
