...
public class IrreqularArray {
	...
	public static void main(String[] args) {
		...
		intArray[0] = new int[3]; // 행의 인덱스 0에 열의 개수 선언 : 열의 개수 3
		intArray[1] = new int[2]; // 행의 인덱스 1에 열의 개수 선언 : 열의 개수 2
		intArray[2] = new int[3]; // 행의 인덱스 2에 열의 개수 선언 : 열의 개수 3
		intArray[3] = new int[2]; // 행의 인덱스 3에 열의 개수 선언 : 열의 개수 2
